    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Alta de Lead</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Inicio</a></li>
              <li class="breadcrumb-item active">Alta de Lead</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <form class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="ipTiporeg"><i class=""></i>
                                  <span class="small">Dimension del cable</span><span class="text-danger">*</span>
                              </label> 
                              <input type="text" class="form-control form-control-sm" id="ipTiporeg"
                                name="ipTiporeg" placeholder="Dimension" required>
                              <div class="invalid-feedback">Ingrese la dimension del cable</div>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="ipTiporeg"><i class=""></i>
                                  <span class="small">Tolerancia</span><span class="text-danger">*</span>
                              </label> 
                              <input type="text" class="form-control form-control-sm" id="ipTiporeg"
                                name="ipTiporeg" placeholder="Tolerancia" required>
                              <div class="invalid-feedback">Ingrese la tolerancia del cable</div>
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group mb-2">
                              <label class="" for="selFamiliaReg"><i class=""></i>
                                  <span class="small">Tipo de tolerancia</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selFamiliaReg">
                              </select>
                              <div class="invalid-feedback">Seleccione la tolerancia</div>
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="form-group mb-2">
                              <label class="" for="ipTiporeg"><i class=""></i>
                                  <span class="small">Cable</span><span class="text-danger">*</span>
                              </label> 
                              <input type="text" class="form-control form-control-sm" id="ipTiporeg"
                                name="ipTiporeg" placeholder="Cable" required>
                              <div class="invalid-feedback">Ingrese el np del cable</div>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="ipTiporeg"><i class=""></i>
                                  <span class="small">Conector 1</span><span class="text-danger">*</span>
                              </label> 
                              <input type="text" class="form-control form-control-sm" id="ipTiporeg"
                                name="ipTiporeg" placeholder="Conector 1" required>
                              <div class="invalid-feedback">Ingrese el np del conector</div>
                          </div>
                        </div><div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="ipTiporeg"><i class=""></i>
                                  <span class="small">Conector 2</span><span class="text-danger">*</span>
                              </label> 
                              <input type="text" class="form-control form-control-sm" id="ipTiporeg"
                                name="ipTiporeg" placeholder="Conector 2" required>
                              <div class="invalid-feedback">Ingrese el np del conector</div>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="selFamiliaReg"><i class=""></i>
                                  <span class="small">Familia 1</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selFamiliaReg">
                              </select>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="selFamiliaReg"><i class=""></i>
                                  <span class="small">Familia 2</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selFamiliaReg">
                              </select>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="selProcesoReg"><i class=""></i>
                                  <span class="small">Proceso 1</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selProcesoReg">
                              </select>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="selProcesoReg"><i class=""></i>
                                  <span class="small">Proceso 2</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selProcesoReg">
                              </select>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="selAcotaReg"><i class=""></i>
                                  <span class="small">Acotacion 1:</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selAcotaReg">
                              </select>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group mb-2">
                              <label class="" for="selAcotaReg"><i class=""></i>
                                  <span class="small">Acotacion 2:</span><span class="text-danger">*</span>
                              </label> 
                              <select class="form-select form-select-sm" aria-label=".form-select example"
                                    id="selAcotaReg">
                              </select>
                        ...
                        <div class="col-lg-12">
                          <div class="form-group mb-2">
                              <label class="" for="ipValorreg"><i class=""><
                              /i>
